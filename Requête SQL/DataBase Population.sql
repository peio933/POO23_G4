...
-- Peuplement de la table Adress -- PAS OK
INSERT INTO Adress (SNB, SN, N_V, PC, ID_C, ID_E) VALUES
(13, 'Rue de la Liberté', 'Paris', 75001, NULL, 1),
(76, 'Avenue des Gobelins', 'Marseille', 13002, NULL, 2),
(99, 'Boulevard de l Université', 'Lyon', 69003, NULL, 3),
(26, 'Rue Jean Jaurès', 'Bordeaux', 33000, NULL, 4),
(1, 'Avenue Victor Hugo', 'Nice', 06000, NULL, 5),
(34, 'Boulevard de Strasbourg', 'Toulouse', 31000, NULL, 6);

INSERT INTO Adress (SNB, SN, N_V, PC, ID_C, ID_E) VALUES
(27, 'Rue de la Liberté', 'Marseille', 13001, NULL, 7),
(98, 'Avenue des Gobelins', 'Paris', 75013, NULL, 8),
(73, 'Boulevard de l Université', 'Toulouse', 31000, NULL, 9),
(19, 'Rue Jean Jaurès', 'Lille', 59000, NULL, 10),
(10, 'Avenue Victor Hugo', 'Nice', 06000, NULL, 11),
(123, 'Boulevard de Strasbourg', 'Bordeaux', 33000, NULL, 12),
(142, 'Rue de la République', 'Lyon', 69002, NULL, 13),
(104, 'Avenue de la Libération', 'Montpellier', 34000, NULL, 14),
(1, 'Boulevard de la Corderie', 'Nantes', 44000, NULL, 15),
(4, 'Rue du Faubourg Saint-Antoine', 'Paris', 75011, NULL, 16),
(39, 'Avenue de la Tranchée', 'Tours', 37000, NULL, 17),
(8, 'Boulevard Gambetta', 'Cannes', 06400, NULL, 18),
(53, 'Rue du Prado', 'Marseille', 13006, NULL, 19),
(83, 'Avenue de la République', 'Nancy', 54000, NULL, 20),
(9, 'Boulevard de l Europe', 'Lyon', 69007, NULL, 21),
(11, 'Rue du Cherche-Midi', 'Paris', 75006, NULL, 22),
(95, 'Avenue du Général Leclerc', 'Versailles', 78000, NULL, 23),
(71, 'Boulevard de la Paix', 'Nice', 06000, NULL, 24),
(147, 'Rue de la Cannebière', 'Marseille', 13001, NULL, 25),
(97, 'Avenue Jean Médecin', 'Nice', 06000, NULL, 26),
(89, 'Boulevard des Allées', 'Toulouse', 31000, NULL, 27),
(66, 'Rue de la Guillotière', 'Lyon', 69003, NULL, 28),
(22, 'Avenue de la Liberté', 'Lille', 59000, NULL, 29),
(55, 'Boulevard de l Europe', 'Paris', 75015, NULL, 30),
(153, 'Rue du Faubourg Saint-Honoré', 'Paris', 75008, NULL, 31),
(154, 'Avenue de la Porte des Ternes', 'Paris', 75017, NULL, 32),
(38, 'Boulevard de la Croix-Rousse', 'Lyon', 69004, NULL, 33),
(23, 'Rue de la République', 'Marseille', 13002, NULL, 34),
(67, 'Avenue du Prado', 'Marseille', 13008, NULL, 35),
(900, 'Boulevard de la Villette', 'Paris', 75019, NULL, 36),
(132, 'Rue du Faubourg Saint-Antoine', 'Paris', 75012, NULL, 37),
(57, 'Avenue des Gobelins', 'Paris', 75005, NULL, 38),
(84, 'Boulevard de l Indépendance', 'Lille', 59000, NULL, 39),
(7, 'Rue de la Paix', 'Nice', 06000, NULL, 40),
(3, 'Avenue de la Libération', 'Marseille', 13004, NULL, 41),
(10, 'Boulevard Gambetta', 'Nice', 06000, NULL, 42),
(13, 'Rue de la Cannebière', 'Marseille', 13001, NULL, 43),
(26, 'Avenue Jean Jaurès', 'Lyon', 69007, NULL, 44),
(39, 'Boulevard des Allées', 'Toulouse', 31000, NULL, 45),
(26, 'Rue de la République', 'Lille', 59000, NULL, 46),
(65, 'Avenue du Général Leclerc', 'Versailles', 78000, NULL, 47),
(91, 'Boulevard de la Paix', 'Nice', 06000, NULL, 48),
(12, 'Rue de la Guillotière', 'Lyon', 69003, NULL, 49),
(103, 'Avenue de la Liberté', 'Lille', 59000, NULL, 50);

INSERT INTO Adress (SNB, SN, N_V, PC, ID_C, ID_E) VALUES -- PAS OK
(5, 'Boulevard des Champs-Élysées', 'Paris', 75008, 1, NULL),
(87, 'Rue de la République', 'Lyon', 69002, 2, NULL),
(92, 'Avenue du Général de Gaulle', 'Angers', 49100, 3, NULL),
(15, 'Boulevard de Strasbourg', 'Toulon', 83000, 4, NULL),
(107, 'Rue de la Canebière', 'Marseille', 13001, 5, NULL),
(45, 'Avenue de la Tranchée', 'Tours', 37000, 6, NULL),
(22, 'Boulevard de l Indépendance', 'Strasbourg', 67000, 7, NULL),
(67, 'Rue de la République', 'Lyon', 69001, 8, NULL),
(93, 'Avenue des Champs-Élysées', 'Paris', 75001, 9, NULL),
(15, 'Boulevard de la Croix-Rousse', 'Lyon', 69004, 10, NULL);


-- Peuplement de la table composed
INSERT INTO composed (ID_O, ID_A, Quantity) VALUES
-- Commande 1
(1, 1, 3),  -- JOSM2010-PARIS-001 - LED_J
(1, 2, 1),  -- JOSM2010-PARIS-001 - LED_R
-- Commande 2
(2, 10, 2),  -- JOSM2012-PARIS-002 - CAP_100nF
(2, 11, 5),  -- JOSM2012-PARIS-002 - RES_470R
(2, 12, 1),  -- JOSM2012-PARIS-002 - LED_V
-- Commande 3
(3, 20, 2),  -- ALJO1998-LYON-001 - SWITCH_TACT
(3, 1, 2),   -- ALJO1998-LYON-001 - LED_J
(3, 2, 1),   -- ALJO1998-LYON-001 - LED_R
-- Commande 4
(4, 13, 4),  -- DAWI2004-ANGERS-001 - IC_741
(4, 1, 5),   -- DAWI2004-ANGERS-001 - LED_J
(4, 4, 1),   -- DAWI2004-ANGERS-001 - CAP_TOF
-- Commande 5
(5, 17, 1),  -- EMWI2022-TOULON-001 - TRANS_PNP
(5, 18, 1),  -- EMWI2022-TOULON-001- DIODE_LED
(5, 19, 4),  -- EMWI2022-TOULON-001- IC_4017
-- Commande 6
(6, 13, 3),  -- MATA1999-MARSEILLE-001 - IC_741
(6, 14, 1),  -- MATA1999-MARSEILLE-001 - SWITCH_DPDT
(6, 15, 2),  -- MATA1999-MARSEILLE-001 - CAP_47uF
(6, 16, 3),  -- MATA1999-MARSEILLE-001 - RES_2K2
-- Commande 7
(7, 8, 10),  -- OLMI2008-TOURS-001 - SWITCH_SPST
(7, 9, 5),  -- OLMI2008-TOURS-001 - POT_10K
-- Commande 8
(8, 3, 7),  -- WIDA2023-STRASBOURG-001 - RES_1K
(8, 4, 4),  -- WIDA2023-STRASBOURG-001 - CAP_TOF
(8, 5, 6),  -- WIDA2023-STRASBOURG-001 - TRANS_NPN
-- Commande 9
(9, 6, 3),  -- SOCL2023-LYON-001 - DIODE_1N4148
(9, 7, 3),  -- SOCL2023-LYON-001 - IC_555
-- Commande 10
(10, 15, 6),  -- ETMO2020-PARIS-001 - CAP_47uF
(10, 18, 2),  -- ETMO2020-PARIS-001 - DIODE_LED
(10, 1, 8),   -- ETMO2020-PARIS-001 - LED_J
-- Commande 11
(11, 14, 7),  -- AVAN2005-LYON-001 - SWITCH_DPDT
(11, 15, 6),  -- AVAN2005-LYON-001 - CAP_47uF
(11, 11, 5);  -- AVAN2005-LYON-001 - RES_470R
